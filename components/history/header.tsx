...
import { X, Calendar, Download, Upload, FileText } from "lucide-react"
        ...
        <Sheet>
          ...
          <SheetContent side="top" className="h-auto">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-medium text-lg">Options d'historique</h3>
              <SheetTrigger asChild>
            ...
            <div className="grid grid-cols-3 gap-4">
              <Button variant="outline" className="flex flex-col items-center h-auto py-4 gap-2">
                <Calendar className="h-5 w-5 text-[#114c3a]" />
                <span className="text-xs">Calendrier</span>
              </Button>
              <Button variant="outline" className="flex flex-col items-center h-auto py-4 gap-2">
                <Download className="h-5 w-5 text-[#114c3a]" />
                <span className="text-xs">Exporter</span>
              </Button>
              <Button variant="outline" className="flex flex-col items-center h-auto py-4 gap-2">
                <Upload className="h-5 w-5 text-[#114c3a]" />
                <span className="text-xs">Importer</span>
              </Button>
              <Button variant="outline" className="flex flex-col items-center h-auto py-4 gap-2">
                <FileText className="h-5 w-5 text-[#114c3a]" />
                <span className="text-xs">Rapports</span>
              </Button>
            </div>
          </SheetContent>
        </Sheet>
        <h1 className="text-2xl font-bold text-[#114c3a]">Historique des Cultures</h1>
      </div>
      <div className="flex items-center gap-3">
